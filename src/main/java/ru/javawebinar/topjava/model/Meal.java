...
public class Meal extends AbstractBaseEntity {
    ...
    @Range(min = 10, max = 5000, message = "should be positive in range from 10 to 5000")
    @NotNull(message = "calories may not be empty")
    //https://stackoverflow.com/questions/46425098/javax-empty-integer-field-validation
